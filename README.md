...
**Work in progress!** This project aims to recreate source code for ***Mario & Luigi: Bowser's Inside Story*** by decompiling its code by hand. **The repository does not contain assets or assembly code.** To build the ROM, you must own an existing
